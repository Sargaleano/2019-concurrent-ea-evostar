...
\cite{alba2002,Luque2011,gong2015distributed}
...
algorithm; even some
authors \cite{Alba2001,evag:gpem} state that using pEAs improves the quality of
...
\cite{A.Bienz2011,kerdprasop2012concurrent,Kerdprasop2013,Stypka2018,butcher2018actor} have
...
parallelized\cite{adeli1994concurrent}. Eventually, this  shows the need use and
...
This paper, as well as similar ones preceding it
 \cite{DBLP:conf/gecco/CruzGGC13,Albert-Cruz2014169,Merelo:2018:MEA:3205651.3208317:anon}, are
